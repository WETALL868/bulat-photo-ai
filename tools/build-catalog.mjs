...
/* Каталог можно собрать не в репозиторий, а в отдельную папку — удобно,
   когда пробную сборку не надо смешивать с честными data/catalog, из
   которых строятся предрендер и карта сайта. */
...
/*
  Отзывов в каталоге нет и быть не может, пока их не пришлют живые люди и
  не одобрит модератор: счётчик, звёзды, микроразметка и карта сайта
